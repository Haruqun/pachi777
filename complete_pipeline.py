...
from web_package_creator import WebPackageCreator
...
class CompletePipeline:
    ...
    def step3_create_package(self, report_file):
        ...
        # パッケージ作成
        packager = WebPackageCreator()
        zip_file = packager.create_package(report_file)
    ...
    def generate_summary_report(self, results):
        """処理サマリーレポート生成"""
        summary_file = f"pipeline_summary_{self.timestamp}.txt"
