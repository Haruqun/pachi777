...
【読み取り方法】
画像内の各項目を、そのラベル名の直下または直後にある数値から読み取ってください。

重要な位置関係：
- 「累計スタート」：右上の黒枠内の上部にある数値
- 「通常」：右上の黒枠内で「通常」というラベルの下の数値  
- 「初回特賞スタート」：画面下部のテーブルで「初回特賞スタート」というラベルの下の数値
- 「大当り回数」：画面上部の赤文字の大きな数字
- 「初当り回数」：画面上部の青文字の大きな数字

各項目は必ずラベル名を確認してから、その直下の数値を読んでください。
