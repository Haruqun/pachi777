...
テーブルの読み方（重要）：
- 基本的に「項目名」のすぐ下にある数値がその項目の値です
- 上下の位置関係を正確に読み取ってください
- 累計スタートは通常3000～5000程度の大きな数値です
- 通常は500～1000程度の数値です
- チャンス中は2000～4000程度の数値です

数値の大きさの目安：
- 累計スタート: 3000～5000（例：3684）
- 通常: 500～1000（例：638）
- チャンス中: 2000～4000（例：3046）
- 初回特賞スタート: 1～999の範囲
- 前日最終スタート: 1～999の範囲
- 最高出玉: 10000～50000（例：43430）
- 最高一撃獲得: 5000～30000（例：18410）
- 現在出玉: -10000～50000の範囲
