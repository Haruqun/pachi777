...
if uploaded_file is not None:
    ...
    if custom_regions_loaded:
        ...
        regions = {
            ...
            'big_hit': {
                'name': '大当り回数',
                'bbox': (70, 580, 250, 730),  # 赤色の大きな25
                'color': 'red'
            },
            'big_hit_rate': {
                'name': '大当り確率',
                'bbox': (70, 730, 250, 780),  # (1/148)
                'color': 'red'
            },
            'first_hit': {
                'name': '初当り回数',
                'bbox': (470, 580, 650, 730),  # 青色の大きな4
                'color': 'blue'
            },
            'first_hit_rate': {
                'name': '初当り確率',
                'bbox': (470, 730, 650, 780),  # (1/469)
                'color': 'blue'
            },
            'total_start': {
                'name': '累計スタート',
            ...
            'normal_count': {
                'name': '通常',
                'bbox': (780, 730, 910, 780),  # 1877
                'color': 'white'
            },
            'chance_count': {
                'name': 'チャンス中',
                'bbox': (990, 730, 1150, 780),  # 1844
                'color': 'white'
            },
            ...
            'ultra': {
                'name': '超',
                'bbox': (70, 840, 150, 920),  # 21
                'color': 'red'
            },
            'middle': {
                'name': '中',
                'bbox': (190, 840, 240, 920),  # 0
                'color': 'red'
            },
            'small': {
                'name': '小',
                'bbox': (280, 840, 330, 920),  # 4
                'color': 'red'
            },
            ...
            'low_chance_hits': {
                'name': '低確中大当り',
                'bbox': (750, 1060, 870, 1100),  # --
                'color': 'white'
            },
            'low_chance_rate': {
                'name': '低確中確率',
                'bbox': (980, 1060, 1150, 1100),  # --
                'color': 'white'
            },
            ...
            'prev_final': {
                'name': '前日最終スタート',
                'bbox': (270, 1180, 390, 1220),  # 107
                'color': 'white'
            },
            'break_count': {
                'name': '突時回数',
                'bbox': (540, 1180, 660, 1220),  # --
                'color': 'white'
            },
            'low_start': {
                'name': '低確スタート',
                'bbox': (750, 1180, 870, 1220),  # --
                'color': 'white'
            },
            'play_time': {
                'name': '遊タイム',
                'bbox': (980, 1180, 1150, 1220),  # --
                'color': 'white'
            },
