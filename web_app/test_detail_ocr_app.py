...
if 'relative_regions' not in st.session_state or st.button("座標を強制更新", key="force_update"):
    ...
    st.session_state.relative_regions = {
        # メイン数値（赤・青の大きい数字）
        'big_hit_count': {
            'bbox': (30, 50, 120, 120),  # 大当り回数 25 (赤大数字)
            'type': 'red_number',
            'inside_black': True,
            'size_pattern': 'large',
            'name': '大当り回数'
        ...
        'first_hit_count': {
            'bbox': (180, 50, 260, 120),  # 初当り回数 4 (青大数字)
            'type': 'blue_number',
            'inside_black': True,
            'size_pattern': 'large',
            'name': '初当り回数'
        ...
        'cumulative_start': {
            'bbox': (330, 50, 410, 90),  # 累計スタート 3721
            'type': 'white_number',
            'inside_black': True,
            'size_pattern': 'medium',
            'name': '累計スタート'
        ...
        'max_payout': {
            'bbox': (340, 140, 430, 165),  # 最高出玉 26830
            'type': 'white_number',
            'inside_black': True,
            'size_pattern': 'medium',
            'name': '最高出玉'
        ...
        # 最高一撃獲得セクション
        'highest_single_win': {
            'bbox': (15, 195, 100, 220),  # 最高一撃獲得 25760
            'type': 'white_number',
            'inside_black': True,
            'size_pattern': 'small',
            'name': '最高一撃獲得'
        ...
        'chance_bonus_count': {
            'bbox': (105, 195, 155, 220),  # チャンス中大当り 21
            'type': 'white_number',
            'inside_black': True,
            'size_pattern': 'small',
            'name': 'チャンス中大当り'
        ...
        'chance_probability': {
            'bbox': (165, 195, 215, 220),  # チャンス中確率 1/87
            'type': 'white_text',
            'inside_black': True,
            'size_pattern': 'small',
            'name': 'チャンス中確率'
        ...
        # 初回特賞・前日最終セクション
        'initial_bonus_start': {
            'bbox': (15, 235, 85, 260),  # 初回特賞スタート 220
            'type': 'white_number',
            'inside_black': True,
            'size_pattern': 'small',
            'name': '初回特賞スタート'
        ...
        'previous_day_final': {
            'bbox': (105, 235, 175, 260),  # 前日最終スタート 107
            'type': 'white_number',
            'inside_black': True,
            'size_pattern': 'small',
            'name': '前日最終スタート'
