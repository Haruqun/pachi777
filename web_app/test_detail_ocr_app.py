...
if uploaded_file is not None:
    ...
    if custom_regions_loaded:
        ...
        # 黒背景が検出できない場合は実際の検出座標を使用（1179px幅の画像用）
        regions = {
            # 上部メイン数値
            'big_hit': {
                'name': '大当り回数',
                'bbox': (128, 636, 287, 741),  # "25"の赤い大きな数字
                'color': 'red'
            },
            'first_hit': {
                'name': '初当り回数', 
                'bbox': (493, 636, 640, 741),  # "4"の青い大きな数字（推定位置）
                'color': 'blue'
            },
            'total_start': {
                'name': '累計スタート',
                'bbox': (845, 638, 1040, 715),  # "_3721"の白い数字
                'color': 'white'
            },
            # 中段データ
            'ultra': {
                'name': '超',
                'bbox': (106, 908, 163, 951),  # "21"
                'color': 'red'
            },
            'middle': {
                'name': '中',
                'bbox': (208, 908, 237, 952),  # "0"
                'color': 'red'
            },
            'small': {
                'name': '小',
                'bbox': (275, 908, 307, 951),  # "4"
                'color': 'red'
            },
            'start': {
                'name': 'スタート',
                'bbox': (520, 897, 660, 957),  # スタート数値領域
                'color': 'white'
            },
            'max_payout': {
                'name': '最高出玉',
                'bbox': (851, 897, 1086, 957),  # "26830"
                'color': 'white'
            },
            # 下段データ
            'max_hit': {
                'name': '最高一撃獲得',
                'bbox': (65, 1066, 213, 1102),  # "25760"（検出結果2）
                'color': 'white'
            },
            'chance_hits': {
                'name': 'チャンス中大当り',
                'bbox': (176, 1066, 209, 1104),  # "21"
                'color': 'white'
            },
            'chance_rate': {
                'name': 'チャンス中確率',
                'bbox': (555, 1066, 663, 1104),  # "1/87"
                'color': 'white'
            },
            'initial_start': {
                'name': '初回特賞スタート',
                'bbox': (96, 1184, 176, 1220),  # "220"
                'color': 'white'
            },
            'prev_final': {
                'name': '前日最終スタート',
                'bbox': (343, 1184, 427, 1220),  # "107"
                'color': 'white'
            },
            # 累計テーブル（8/6）
            'date_86': {
                'name': '日付8/6',
                'bbox': (51, 1327, 124, 1364),  # "8/6"
                'color': 'white'
            },
            'total_86': {
                'name': '累計8/6',
                'bbox': (204, 1326, 321, 1362),  # "3772"
                'color': 'white'
            },
            'first_rate_86': {
                'name': '初当り確率8/6',
                'bbox': (432, 1326, 570, 1364),  # "1/277"
                'color': 'white'
            },
            'chance_rate_86': {
                'name': 'チャンス中確率8/6',
                'bbox': (693, 1326, 831, 1364),  # "1/166"
                'color': 'white'
            },
            'payout_86': {
                'name': '最高出玉8/6',
                'bbox': (953, 1326, 1099, 1362),  # "14670"
                'color': 'white'
            },
            # 累計テーブル（8/5）
            'date_85': {
                'name': '日付8/5',
                'bbox': (51, 1386, 124, 1424),  # "8/5"
                'color': 'white'
            },
            'total_85': {
                'name': '累計8/5',
                'bbox': (204, 1386, 320, 1422),  # "3213"
                'color': 'white'
            },
            'first_rate_85': {
                'name': '初当り確率8/5',
                'bbox': (432, 1386, 570, 1424),  # "1/324"
                'color': 'white'
            },
            'chance_rate_85': {
                'name': 'チャンス中確率8/5',
                'bbox': (709, 1386, 813, 1424),  # "1/79"
                'color': 'white'
            },
            'payout_85': {
                'name': '最高出玉8/5',
                'bbox': (951, 1386, 1099, 1422),  # "22100"
                'color': 'white'
            }
        }
