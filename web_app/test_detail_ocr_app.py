...
if uploaded_file is not None:
    ...
    if custom_regions_loaded:
        ...
        regions = {
            ...
            'big_hit': {
                'name': '大当り回数',
                'bbox': (75, 590, 245, 730),  # 赤色の大きな25
                'color': 'red'
            },
            'big_hit_rate': {
                'name': '大当り確率',
                'bbox': (75, 730, 245, 780),  # (1/148)
                'color': 'red'
            },
            'first_hit': {
                'name': '初当り回数',
                'bbox': (475, 590, 645, 730),  # 青色の大きな4
                'color': 'blue'
            },
            'first_hit_rate': {
                'name': '初当り確率',
                'bbox': (475, 730, 645, 780),  # (1/469)
                'color': 'blue'
            },
            'total_start': {
                'name': '累計スタート',
            ...
            'ultra': {
                'name': '超',
                'bbox': (75, 850, 145, 920),  # 21
                'color': 'red'
            },
            'middle': {
                'name': '中',
                'bbox': (195, 850, 235, 920),  # 0
                'color': 'red'
            },
            'small': {
                'name': '小',
                'bbox': (285, 850, 325, 920),  # 4
                'color': 'red'
            },
