...
if uploaded_file is not None:
    ...
    if custom_regions_loaded:
        ...
        regions = {
            ...
            'big_hit': {
                'name': '大当り回数',
                'bbox': (86, 597, 256, 737),  # 赤色の大きな25
                'color': 'red'
            },
            'big_hit_rate': {
                'name': '大当り確率',
                'bbox': (86, 737, 256, 787),  # (1/148)
                'color': 'red'
            },
            'first_hit': {
                'name': '初当り回数',
                'bbox': (486, 597, 656, 737),  # 青色の大きな4
                'color': 'blue'
            },
            'first_hit_rate': {
                'name': '初当り確率',
                'bbox': (486, 737, 656, 787),  # (1/469)
                'color': 'blue'
            },
            'total_start': {
                'name': '累計スタート',
                'bbox': (897, 645, 1051, 698),  # 3721
                'color': 'white'
            },
            'normal_count': {
                'name': '通常',
                'bbox': (796, 737, 921, 787),  # 1877
                'color': 'white'
            },
            'chance_count': {
                'name': 'チャンス中',
                'bbox': (1011, 737, 1161, 787),  # 1844
                'color': 'white'
            },
            ...
            'ultra': {
                'name': '超',
                'bbox': (86, 857, 156, 927),  # 21
                'color': 'red'
            },
            'middle': {
                'name': '中',
                'bbox': (206, 857, 246, 927),  # 0
                'color': 'red'
            },
            'small': {
                'name': '小',
                'bbox': (296, 857, 336, 927),  # 4
                'color': 'red'
            },
            ...
            'start': {
                'name': 'スタート',
                'bbox': (531, 857, 676, 927),  # 369
                'color': 'white'
            },
            'max_payout': {
                'name': '最高出玉',
                'bbox': (862, 904, 1098, 964),  # 26830
                'color': 'white'
            },
            ...
            'max_hit': {
                'name': '最高一撃獲得',
                'bbox': (76, 1073, 224, 1109),  # 25760
                'color': 'white'
            },
            'chance_hits': {
                'name': 'チャンス中大当り',
                'bbox': (291, 1073, 391, 1109),  # 21
                'color': 'white'
            },
            'chance_rate': {
                'name': 'チャンス中確率',
                'bbox': (566, 1073, 674, 1111),  # 1/87
                'color': 'white'
            },
            'low_chance_hits': {
                'name': '低確中大当り',
                'bbox': (771, 1073, 871, 1109),  # --
                'color': 'white'
            },
            'low_chance_rate': {
                'name': '低確中確率',
                'bbox': (996, 1073, 1161, 1109),  # --
                'color': 'white'
            },
            ...
            'initial_start': {
                'name': '初回特賞スタート',
                'bbox': (107, 1191, 193, 1227),  # 220
                'color': 'white'
            },
            'prev_final': {
                'name': '前日最終スタート',
                'bbox': (291, 1191, 391, 1227),  # 107
                'color': 'white'
            },
            'break_count': {
                'name': '突時回数',
                'bbox': (566, 1191, 666, 1227),  # --
                'color': 'white'
            },
            'low_start': {
                'name': '低確スタート',
                'bbox': (771, 1191, 871, 1227),  # --
                'color': 'white'
            },
            'play_time': {
                'name': '遊タイム',
                'bbox': (996, 1191, 1161, 1227),  # --
                'color': 'white'
            },
            ...
            'date_86': {
                'name': '日付8/6',
                'bbox': (61, 1333, 135, 1371),  # 8/6
                'color': 'white'
            },
            'total_86': {
                'name': '累計8/6',
                'bbox': (215, 1333, 333, 1369),  # 3772
                'color': 'white'
            },
            'first_rate_86': {
                'name': '初当り確率8/6',
                'bbox': (443, 1333, 581, 1371),  # 1/277
                'color': 'white'
            },
            'chance_rate_86': {
                'name': 'チャンス中確率8/6',
                'bbox': (704, 1333, 842, 1371),  # 1/166
                'color': 'white'
            },
            'payout_86': {
                'name': '最高出玉8/6',
                'bbox': (964, 1333, 1110, 1369),  # 14670
                'color': 'white'
            },
            ...
            'date_85': {
                'name': '日付8/5',
                'bbox': (61, 1393, 135, 1431),  # 8/5
                'color': 'white'
            },
            'total_85': {
                'name': '累計8/5',
                'bbox': (215, 1393, 332, 1429),  # 3213
                'color': 'white'
            },
            'first_rate_85': {
                'name': '初当り確率8/5',
                'bbox': (443, 1393, 581, 1431),  # 1/324
                'color': 'white'
            },
            'chance_rate_85': {
                'name': 'チャンス中確率8/5',
                'bbox': (720, 1393, 826, 1431),  # 1/79
                'color': 'white'
            },
            'payout_85': {
                'name': '最高出玉8/5',
                'bbox': (962, 1393, 1110, 1429),  # 22100
                'color': 'white'
            }
        }
