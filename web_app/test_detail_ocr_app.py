...
if uploaded_file is not None:
    ...
    if custom_regions_loaded:
        ...
        regions = {
            ...
            'stat_1': {
                'name': '現在',
                'bbox': (169, 2035, 210, 2063),  # 実際の検出座標
                'color': 'white'
            },
            'stat_2': {
                'name': 'チャンス',
                'bbox': (283, 2035, 324, 2063),  # 実際の検出座標
                'color': 'white'
            },
            'stat_3': {
                'name': '突時回数',
                'bbox': (512, 2035, 552, 2063),  # 実際の検出座標
                'color': 'white'
            },
            'stat_4': {
                'name': '低確スタート',
                'bbox': (968, 2035, 1009, 2063),  # 実際の検出座標
                'color': 'white'
            },
            'stat_5': {
                'name': '遊タイム',
                'bbox': (1082, 2035, 1123, 2063),  # 実際の検出座標
                'color': 'white'
            }
        }
